...
public class task03_Alert extends BaseTest {
/*
 ...
 */
    ...
    public void dismissAlert() {
        ...
        Assert.assertFalse(driver.findElement(By.id("result")).getText().contains("successfully"));
    }
    ...
    public void sendKeysAlert() {
        ...
        jsPrompt.click();
        driver.switchTo().alert().sendKeys("Eren");
        driver.switchTo().alert().accept();

        Assert.assertTrue(driver.findElement(By.id("result")).getText().contains("Eren"));
